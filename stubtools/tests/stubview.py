...
# @Last Modified time: 2018-11-20 12:27:59
# --------------------------------------------
# import unittest
# import os
...
from stubtools.management.commands.stubview import Command
...
class TestStubListView(TestCase):
    ...
    def test_template_view(self):
        ...
        self.cmd.process(app_name, view_name, 'ListView', model="Boo")
